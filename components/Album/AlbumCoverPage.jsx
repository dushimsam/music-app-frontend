          ...
          <div className="container">
            <div className="row justify-content-start">
              <div className="col-3 pt-4">
               <img src="/test/image2.jpg" alt="cover-image" className="img-thumbnail" style={styles.image}/>
              </div>
              <div className="col-5 pt-4">
                <h1 className="text-light font-weight-bold mt-5" style={styles.title}>{`Country music`}</h1>
