...
export default function Register() {
    ...
    const initialErrors = {
        name: [], email: [], username: [], password: [], clubs: [],
    };
    ...
    const submitForm = async (event) => {
        try {
            ...
            const user = {
                ...
                clubs: selectedClubs.map((club) => club._id)
            };
            ...
            if (valid.passes(undefined)) {
                ...
                let post_user = {...user}
                post_user.name = user.username;
                let res = await AuthService.register(post_user);
    ...
    return (<ForbiddenPage>
        ...
        <div className="row mx-0">
            ...
            <div className="col-md-8 col-7 justify-content-center">
                <div
                    className="vh-100 d-md-flex flex-md-column  align-items-center justify-content-center mt-5 mt-md-2">
                    ...
                    <form onSubmit={submitForm}>
                        ...
                        {/*        className={`form-control col-12 ${errors.name.length > 0 && "is-invalid"} _input`}*/}
                        {/*    />*/}
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                id="email"
                                ref={emailContainer}
                                className={`form-control col-12 ${errors.email.length > 0 && "is-invalid"} _input`}
                            />
                            <div className="invalid-feedback">
                                {errors.email[0]}
                            </div>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                className={`form-control col-12 ${errors.username.length > 0 && "is-invalid"} _input`}
                            />
                            <div className="invalid-feedback">
                                {errors.username[0]}
                            </div>
